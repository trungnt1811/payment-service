...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM blockchain_network_metadata WHERE alias = 'BSC') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM blockchain_network_metadata WHERE alias = 'AVAX C-Chain') THEN
        INSERT INTO blockchain_network_metadata (alias, name, icon_base64)
        VALUES 
            (
                'AVAX C-Chain', 
