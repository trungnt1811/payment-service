...
// Source: internal/adapters/cache/types/cache.go
//
// Generated by this command:
//
//	mockgen -source=internal/adapters/cache/types/cache.go -destination=internal/adapters/cache/mocks/mock_cache.go -package=mocks
//
...
// GetAllMatching mocks base method.
func (m *MockCacheClient) GetAllMatching(ctx context.Context, prefix string, valFactory func() any) ([]any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllMatching", ctx, prefix, valFactory)
	ret0, _ := ret[0].([]any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllMatching indicates an expected call of GetAllMatching.
func (mr *MockCacheClientMockRecorder) GetAllMatching(ctx, prefix, valFactory any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllMatching", reflect.TypeOf((*MockCacheClient)(nil).GetAllMatching), ctx, prefix, valFactory)
}
...
// GetAllMatching mocks base method.
func (m *MockCacheRepository) GetAllMatching(prefix fmt.Stringer, valFactory func() any) ([]any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllMatching", prefix, valFactory)
	ret0, _ := ret[0].([]any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetAllMatching indicates an expected call of GetAllMatching.
func (mr *MockCacheRepositoryMockRecorder) GetAllMatching(prefix, valFactory any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllMatching", reflect.TypeOf((*MockCacheRepository)(nil).GetAllMatching), prefix, valFactory)
}
