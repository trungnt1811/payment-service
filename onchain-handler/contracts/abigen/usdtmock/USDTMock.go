...
func (_Usdtmock *UsdtmockCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Usdtmock.contract.Call(opts, &out, "owner")
...
//
// Solidity: function owner() view returns(address)
func (_Usdtmock *UsdtmockSession) Owner() (common.Address, error) {
	return _Usdtmock.Contract.Owner(&_Usdtmock.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_Usdtmock *UsdtmockCallerSession) Owner() (common.Address, error) {
	return _Usdtmock.Contract.Owner(&_Usdtmock.CallOpts)
}
...
func (_Usdtmock *UsdtmockTransactor) Mint(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdtmock.contract.Transact(opts, "mint", to, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 amount) returns()
func (_Usdtmock *UsdtmockSession) Mint(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdtmock.Contract.Mint(&_Usdtmock.TransactOpts, to, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 amount) returns()
func (_Usdtmock *UsdtmockTransactorSession) Mint(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdtmock.Contract.Mint(&_Usdtmock.TransactOpts, to, amount)
}
...
func (_Usdtmock *UsdtmockTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Usdtmock.contract.Transact(opts, "renounceOwnership")
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Usdtmock *UsdtmockSession) RenounceOwnership() (*types.Transaction, error) {
	return _Usdtmock.Contract.RenounceOwnership(&_Usdtmock.TransactOpts)
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Usdtmock *UsdtmockTransactorSession) RenounceOwnership() (*types.Transaction, error) {
	return _Usdtmock.Contract.RenounceOwnership(&_Usdtmock.TransactOpts)
}
...
func (_Usdtmock *UsdtmockTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Usdtmock.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Usdtmock *UsdtmockSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Usdtmock.Contract.TransferOwnership(&_Usdtmock.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Usdtmock *UsdtmockTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Usdtmock.Contract.TransferOwnership(&_Usdtmock.TransactOpts, newOwner)
}
...
// UsdtmockOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Usdtmock contract.
type UsdtmockOwnershipTransferredIterator struct {
	Event *UsdtmockOwnershipTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *UsdtmockOwnershipTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UsdtmockOwnershipTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *UsdtmockOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UsdtmockOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// UsdtmockOwnershipTransferred represents a OwnershipTransferred event raised by the Usdtmock contract.
type UsdtmockOwnershipTransferred struct {
...
func (_Usdtmock *UsdtmockFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*UsdtmockOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Usdtmock.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &UsdtmockOwnershipTransferredIterator{contract: _Usdtmock.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Usdtmock *UsdtmockFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *UsdtmockOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Usdtmock.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UsdtmockOwnershipTransferred)
				if err := _Usdtmock.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Usdtmock *UsdtmockFilterer) ParseOwnershipTransferred(log types.Log) (*UsdtmockOwnershipTransferred, error) {
	event := new(UsdtmockOwnershipTransferred)
	if err := _Usdtmock.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
		return nil, err
	}
